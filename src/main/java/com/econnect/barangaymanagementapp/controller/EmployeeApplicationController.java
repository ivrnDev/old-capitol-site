...
import com.econnect.barangaymanagementapp.controller.table.employee.EmployeeApplicationTableController;
...
public class EmployeeApplicationController {
    ...
    private EmployeeApplicationTableController tableController;

    private final PauseTransition searchDelay = new PauseTransition(Duration.millis(300));
    private List<Employee> allApplications;
    private StackPane loadingIndicator;

    public EmployeeApplicationController(DependencyInjector dependencyInjector) {
