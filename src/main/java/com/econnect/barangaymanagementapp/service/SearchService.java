    ...
    public Predicate<Resident> createResidentFilter(String searchText) {
        return resident -> {
            return (resident.getId() != null && resident.getId().toLowerCase().contains(searchText))
                    ...
                    || (resident.getMotherTounge() != null && resident.getMotherTounge().getName() != null && resident.getMotherTounge().getName().toLowerCase().contains(searchText))
                    ...
                    || (resident.getReligion() != null && resident.getReligion().getName() != null && resident.getReligion().getName().toLowerCase().contains(searchText))
